# Generated by Django 5.0.2 on 2025-08-21 21:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wash_type', models.CharField(choices=[('steam', 'Steam'), ('waterless', 'Waterless'), ('traditional', 'Traditional')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('detailer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='main.detailer')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
