...
# Configure the channels layer for the websocket
CHANNEL_LAYERS = {
    "default": {
...
# Configure celery using redis as the broker and result backend
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://cancel-periodically-sally-expressed.trycloudflare.com",
]
